...
export const fetchCurrentUserWithDrizzle =
	async (): Promise<UserWithEmail | null> => {
...
export const updateUserWithDrizzle = async (
	userId: string,
	data: UpdateUser,
...
export const updateUserAvatarWithDrizzle = async (
	userId: string,
	file: File,
