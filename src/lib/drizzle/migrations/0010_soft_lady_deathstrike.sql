...
CREATE TABLE "daily_activities" (
	...
	CONSTRAINT "daily_activities_user_id_activity_date_unique" UNIQUE("user_id","activity_date")
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "rate_limits" DROP CONSTRAINT "rate_limits_user_id_action_type_window_start_unique";--> statement-breakpoint
